...
//! - MiniMax / 百度千帆 / 阶跃星辰 / 百川 / 小米 MiMo / Together 六家于 2026-09-23
...
pub(super) const CHAT_PRESETS: &[ProviderPreset] = &[
    ...
    ProviderPreset {
        ...
        group_key: GROUP_CHINA.0,
        group_label: GROUP_CHINA.1,
        label_key: "providerTemplate.minimax.label",
        label: "MiniMax（稀宇科技）",
        hint_key: Some("providerTemplate.minimax.hint"),
        hint: Some("国内站地址；海外账号的密钥在这里用不了"),
        base_url: Some("https://api.minimax.chat/v1"),
        model: "MiniMax-M1",
        models: &[
            ModelOption::plain("MiniMax-M1"),
            ModelOption::plain("abab6.5s-chat"),
        ],
        protocol: Protocol::OpenAiCompatible,
        match_hosts: &["api.minimax.chat"],
        extra_fields: NO_EXTRA,
        apply_url: None,
        is_local: false,
        verified_at: None,
    ...
    ProviderPreset {
        ...
        group_key: GROUP_CHINA.0,
        group_label: GROUP_CHINA.1,
        label_key: "providerTemplate.qianfan.label",
        label: "百度千帆",
        hint_key: Some("providerTemplate.qianfan.hint"),
        hint: Some("文心系列；用千帆 v2 接口的 API Key，不是旧版 AK / SK"),
        base_url: Some("https://qianfan.baidubce.com/v2"),
        model: "ernie-4.5-turbo-128k",
        models: &[ModelOption::plain("ernie-4.5-turbo-128k")],
        protocol: Protocol::OpenAiCompatible,
        match_hosts: &["qianfan.baidubce.com"],
        extra_fields: NO_EXTRA,
        apply_url: None,
        is_local: false,
        verified_at: None,
    ...
    ProviderPreset {
        ...
        group_key: GROUP_CHINA.0,
        group_label: GROUP_CHINA.1,
        label_key: "providerTemplate.stepfun.label",
        label: "阶跃星辰",
        hint_key: Some("providerTemplate.stepfun.hint"),
        hint: Some("Step 系列；flash 档便宜快，长文本选 16k 档"),
        base_url: Some("https://api.stepfun.com/v1"),
        model: "step-1-flash",
        models: &[
            ModelOption::plain("step-1-flash"),
            ModelOption::plain("step-2-16k"),
        ],
        protocol: Protocol::OpenAiCompatible,
    ...
    ProviderPreset {
        ...
        group_key: GROUP_CHINA.0,
        group_label: GROUP_CHINA.1,
        label_key: "providerTemplate.baichuan.label",
        label: "百川智能",
        hint_key: Some("providerTemplate.baichuan.hint"),
        hint: Some("Baichuan 系列，国内直连"),
        base_url: Some("https://api.baichuan-ai.com/v1"),
        model: "Baichuan4-Turbo",
        models: &[
            ModelOption::plain("Baichuan4-Turbo"),
            ModelOption::plain("Baichuan3-Turbo-128k"),
        ],
        protocol: Protocol::OpenAiCompatible,
    ...
    ProviderPreset {
        ...
        group_key: GROUP_CHINA.0,
        group_label: GROUP_CHINA.1,
        label_key: "providerTemplate.mimo.label",
        label: "小米 MiMo",
        hint_key: Some("providerTemplate.mimo.hint"),
        hint: Some("小米自研；flash 档便宜快"),
        base_url: Some("https://api.xiaomimimo.com/v1"),
        model: "mimo-v2-flash",
        models: &[
            ModelOption::plain("mimo-v2-flash"),
            ModelOption::plain("mimo-v2-pro"),
        ],
        protocol: Protocol::OpenAiCompatible,
    ...
    ProviderPreset {
        ...
        group_key: GROUP_INTERNATIONAL.0,
        group_label: GROUP_INTERNATIONAL.1,
        label_key: "providerTemplate.together.label",
        label: "Together AI",
        hint_key: Some("providerTemplate.together.hint"),
        hint: Some("开源模型托管；国内访问通常需要代理"),
        base_url: Some("https://api.together.xyz/v1"),
        model: "meta-llama/Llama-3.3-70B-Instruct-Turbo",
        models: &[ModelOption::plain(
